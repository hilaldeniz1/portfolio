      ...
      const response = await fetch(url, {
        ...
        body:
          JSON.stringify({
            ...
            user_id: publicKey,
            template_params: {
              user_name: inputRef.current.user_name.value,
              user_email: inputRef.current.user_email.value,
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">
                  hilaldeniz677@gmail.com
                </span>
                <a
                  href="mailto:hilaldeniz677@gmail.com"
                  target="_blank"
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <h3 className="conact__card-title">Messenger(meta)</h3>
                  <span className="contact__card-data">
                    Hilal Habibe GÜLGÜN
                  </span>
                  <a
